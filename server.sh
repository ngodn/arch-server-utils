...
COMPONENTS=(
  ...
  "mise|Mise|Version manager (Node, Ruby, Python, etc.)|0"
  "tailscale|Tailscale|Mesh VPN for secure server networking|0"
  "docker-dbs|Docker DBs|MySQL, PostgreSQL, Redis, MongoDB, MariaDB, MSSQL|0"
  "claude-code|Claude Code|AI coding assistant for the terminal|0"
  "dev-env|Dev Environments|Languages via mise (Node, Python, Ruby, Go, etc.)|0"
